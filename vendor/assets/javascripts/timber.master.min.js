  ...
  var t,
    ...
    v = {
      init: function () {
        ...
        $("body").data("aux-nav", !1);
        var t = $(s).data("animation")
            ? $(s).data("animation")
            : "no-transition",
          h = $(s).is("[data-no-scrollbar]") ? "no-scrollbar" : "scrollbar";
        "no-transition" === t && $(e).addClass(t + "-reset"),
          $(e).addClass("reveal-side-navigation"),
          $(s).addClass(t + "-reset " + h);
        var f = $(s).hasClass("enter-right") ? "right" : "left";
        Z
          ? (m = "left" === f ? a : n)
          : ((m = "left" === f ? l : d), $(s).addClass("hide"));
        var m = m.split(".").join("");
        (c = c.split(".").join("")),
          $(o).on(i, function (a) {
            if ((a.preventDefault(), $(s).hasClass("active"))) v.closeNav(m, t);
              ...
              ai || $(".header-inner").css({ top: n + "px" }),
                Z
                  ? ($(e)
                      .addClass(m + " inactive " + t)
                      .css({ transitionTimingFunction: ei[u] }),
                    $(s)
                      .addClass("active " + t)
                      .css({ transitionTimingFunction: ei[u] }))
                  : ($(e).addClass(m),
                ...
                $(e).on(ii, function (e) {
                  return e.target !== $(this)[0]
                    ? !1
                    : (e.stopPropagation(),
                      $(this).off(ii),
                      void $(".reveal-side-navigation").on(i, function () {
            ...
            $(e).on(ii, function (t) {
              return t.target !== $(this)[0]
                ...
                : (t.stopPropagation(),
                  ...
                  $(e).removeClass("inactive"),
                  $(s).removeClass("active"),
                  void (ai || $(".header-inner").css({ top: 0 })));
            }))
          : ($(e).removeClass(t + " " + i),
            $(s).addClass("hide").removeClass("active")),
          $("body").data("aux-nav", !1);
      },
    },
    ...
    C = {
          ...
          $(m).on(i, function (i) {
            i.preventDefault(),
              $(h).hasClass("active")
                ? C.closeNav(t)
                : ($("body").data("aux-nav", !0),
                  $("html, body").addClass(g),
                  Z
                    ? $(h)
                        .addClass("active " + t)
                        .css({ transitionTimingFunction: ei[p] })
                    : $(h).addClass("active"),
                  $(h).on(ii, function (t) {
                    return t.target !== $(this)[0]
                      ? !1
      ...
      closeNav: function (t) {
        Z
          ? ($(h).removeClass(t),
            "no-transition" === t &&
              ($("html, body").removeClass(g), $(h).removeClass("active")),
            $(h).on(ii, function (t) {
              return t.target !== $(this)[0]
                ? !1
                : (t.stopPropagation(),
                  k.state(!1),
                  $(this).off(ii),
                  $("html, body").removeClass(g),
                  void $(h).removeClass("active"));
            }))
          : $(h).removeClass("active").css({ top: "-100%" }),
          $("body").data("aux-nav", !1);
      },
    },
    ...
    D = {
      init: function () {
        $(window).on("scroll", function () {
          return $(N).is("[data-no-hide]")
            ? !1
            : void ($(this).scrollTop() > x ? $(N).fadeIn(E) : $(N).fadeOut(E));
        }),
          $(N).on(i, function (t) {
    ...
    V = {
      ...
      accordions: function () {
        $(A).each(function () {
          var t = $(this).find("li > a");
          t.each(function () {
            $(this).closest(A).is("[data-toggle-icon]") &&
              ($(this).find("span").length ||
              $(this).parent().hasClass("active")
                ? !$(this).find("span").length &&
                  $(this).parent().hasClass("active") &&
                  $(this).prepend('<span class="' + H + '" />')
                : $(this).prepend('<span class="' + F + '" />')),
              $(this).on(i, function () {
                var t = $(this),
                  i = t.attr("href"),
                ...
                return (
                  clearTimeout(n),
                  (n = t.parent().hasClass("active")
                    ? setTimeout(function () {
                        t.closest(A).is("[data-toggle-multiple]")
                          ? t
                              .siblings(e)
                    ...
                    : setTimeout(function () {
                        ...
                        t.closest(A).is("[data-toggle-multiple]") ||
                          (a.removeClass("no-transition").css({ height: 0 }),
                          t.closest(A).find("li").removeClass("active")),
                  ...
                  Z
                    ? $(this)
                        ...
                        .on(ii, function (t) {
                          return (
                            t.stopPropagation(),
                            t.target !== $(this)[0] ? !1 : void $(this).remove()
                          );
                        })
                    : $(this)
                        .parent()
                        .animate({ opacity: 0 }, J, L, function () {
                          $(this).remove();
                        });
              });
        });
          ...
          $(this)
            ...
            .each(function () {
              $(this).on(i, function (i) {
                i.preventDefault(),
                  $(R).children(".button, button").removeClass("active");
                var e = $(this).parent().children(".dropdown-list");
                return $(this).parent().hasClass("disabled")
                  ? !1
                  : ($(".dropdown-list").not($(e)).removeClass("active"),
                    $(e).hasClass("active")
                      ? ($(e).removeClass("active"),
                        $(this).removeClass("active"))
                      : ($(e).addClass("active"), $(this).addClass("active")),
                    void $(document).on("click.closeDropdown", function (i) {
      ...
      rollovers: function () {
        Z
          ? $(U).each(function () {
              var t,
                i = $(this).data("hover-speed")
                  ? $(this).data("hover-speed")
                  : J,
                e = $(this).data("hover-easing")
                  ? $(this).data("hover-easing")
                  : K,
                a = $(this).data("hover-bkg-opacity")
              ...
              $(this)
                ...
                $(this).find(G).css({ backgroundColor: t });
            })
          : $(U)
              .find(".overlay-link")
              .mouseenter(function () {
                $(this)
                  ...
                  .css({ opacity: 0 })
                  .stop()
                  .animate({ opacity: 1 }, J, K);
              })
              .mouseleave(function () {
                $(this).find(G).stop().animate({ opacity: 0 }, J, K);
              });
      },
    ...
    Z =
      void 0 !== Y.transition ||
      void 0 !== Y.WebkitTransition ||
      void 0 !== Y.MozTransition ||
      void 0 !== Y.MsTransition ||
      void 0 !== Y.OTransition,
    _ = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
  for (var ti in _)
    void 0 !== Y[_[ti]] &&
      (t = "-" + _[ti].replace("Transform", "").toLowerCase());
  var ii =
...
!(function (a, e, t, i) {
  ...
  function s(e) {
    e.find(".tms-caption").each(function () {
      ...
      e.addClass(e.is("[data-no-scale]") ? "no-scale" : "scale"),
        a.each(t, function (a, t) {
          t = t.split(":");
          var i = t[0],
            s = t[1];
          "opacity" === i && e.data("o", s),
            "scale" === i && e.data("s", s),
            "easing" === i && e.data("e", s),
            "transX" === i && e.data("tx", parseFloat(s)),
            "transY" === i && e.data("ty", parseFloat(s)),
            "transZ" === i && e.data("tz", parseFloat(s)),
            "rotateX" === i && e.data("rx", parseFloat(s)),
            "rotateY" === i && e.data("ry", parseFloat(s)),
            "rotateZ" === i && e.data("rz", parseFloat(s)),
            "duration" === i && e.data("du", parseFloat(s)),
            "delay" === i && e.data("de", parseFloat(s));
        }),
        e.data("w", parseFloat(e.css("width"))),
        e.data("h", parseFloat(e.css("height"))),
        e.data("fs", parseFloat(e.css("font-size"))),
        e.data("lh", parseFloat(e.css("line-height"))),
        e.data("pt", parseFloat(e.css("padding-top"))),
        e.data("pr", parseFloat(e.css("padding-right"))),
        e.data("pb", parseFloat(e.css("padding-bottom"))),
        e.data("pl", parseFloat(e.css("padding-left"))),
        e.data("mt", parseFloat(e.css("margin-top"))),
        e.data("mr", parseFloat(e.css("margin-right"))),
        e.data("mb", parseFloat(e.css("margin-bottom"))),
        e.data("ml", parseFloat(e.css("margin-left"))),
        e.data("bt", parseFloat(e.css("border-top-width"))),
        e.data("br", parseFloat(e.css("border-right-width"))),
        e.data("bb", parseFloat(e.css("border-bottom-width"))),
        e.data("bl", parseFloat(e.css("border-left-width")));
    });
  }
  function n(e, i, s) {
    ...
    n.each(function () {
      ...
      if (
        (d > 0 &&
          (i.lazyLoad ? c.appendTo(n) : e.find(c).length || c.appendTo(e)),
        l)
      ) {
        E &&
          n.is("[data-video-bkg]") &&
          n.children("video").css({ display: "none" });
        ...
        ? n.find("img").each(function (e, l) {
            ...
            if (
              (((t.isRetinaDevice() && i.retinaSupport) ||
                ...
                ((!E && !i.retinaSupportMobile) ||
                  (E && i.retinaSupportMobile)) &&
                (l.match(/\.(svg)/i) ||
                  (l = a(this)
                    .data("src")
                    .replace(c, i.retinaSuffix + c))),
              n.data("overlay-bkg-color") && !n.find(".tms-overlay").length)
            )
              var u = n.data("overlay-bkg-color").replace("#", ""),
                ...
                m = "rgba( " + p + "," + f + "," + v + "," + h / 1 + " )",
                g = a('<div class="tms-overlay" />')
                  .css({ backgroundColor: m, opacity: 0 })
                  .appendTo(n);
            a(this)
              .css({ opacity: 0 })
              .attr("src", l)
              .on("load", function () {
                ...
                a(this).data("loaded", !0).css({ opacity: 1 }),
                  n.find(g).css({ opacity: 1 }),
                  e++,
                  e === d && (o++, r(n, o, i, s));
              })
              .one("error", function () {
  ...
  function r(a, e, t, i) {
    ...
    var s = a.closest(".tm-slider-container"),
      ...
      d = null;
    if (
      (a.find(".no-transition").css({ visibility: "visible" }),
      s.data("setup", !0),
      s.data("first-load", !1),
      0 === s.height() && !s.data("height") && a.hasClass("active"))
    ) {
      r.children("img").css({ maxHeight: "none" });
      var l = r.children("img").height();
      s.data("refH", l),
        s.css({ height: l + "px" }),
        r.children("img").css({ maxHeight: "100%" });
    }
    if (
      (g(a, t),
      m(s, t),
      t.carousel &&
        !t.lazyLoad &&
        (n.children().css({ opacity: 1 }), n.css({ opacity: 0 })),
      s.find("iframe, video").css({ opacity: 1 }),
      e === n.children().length && t.onLoadEnd && t.onLoadEnd(),
      t.lazyLoad || e !== n.children().length
        ? t.lazyLoad &&
          1 === e &&
          (s.data("loaded", !0), t.autoAdvance && i.initSlideshow())
        : (s.data("loaded", !0), t.autoAdvance && i.initSlideshow()),
      t.lazyLoad)
    ) {
      if (
        (a.find(".tm-loader").length && a.find(".tm-loader").remove(),
        (a.is(r) || t.carouselVisible > 1) && a.find(".tms-caption").show(),
        !a.hasClass("active"))
      )
        return !1;
      A
        ? (r.css({ transition: "none", opacity: 0 }),
          clearTimeout(d),
      ...
      e === n.children().length &&
        (s.find(".tm-loader").length && s.find(".tm-loader").remove(),
        r.find(".tms-caption").show(),
        t.carouselVisible > 1 && s.find(".tms-caption").show(),
        A
          ? t.carousel
            ? n.css({
                transitionProperty: "opacity",
        ...
        s.find(".tms-arrow-nav, .tms-pagination").css({ display: "block" }));
  }
  var o = function (r, o) {
      // TODO
      if (1) return;
      ...
      var c = a.extend({}, a.fn.avalancheSlider.tmsOpts, o),
        ...
        y = c.fulscreen
          ...
          : c.fullwidth
          ? c.scaleUnder
          : parseFloat(p.data("width") ? p.data("width") : p.css("width")),
        x = c.fulscreen
          ? a(t).height()
          : parseFloat(p.data("height") ? p.data("height") : p.css("height")),
        S = p.find(".tms-slides"),
      ...
      if (
        (S.children(".tms-slide").each(function (e) {
          e++,
            ...
            (c.forceFit || a(this).is("[data-force-fit]")) &&
              a(this).addClass("tms-forcefit");
        }),
        c.lazyLoad || F.css({ opacity: 0 }),
        (c.scaleUnder = p.data("scale-under")
          ? p.data("scale-under")
          : c.scaleUnder),
        (c.scaleMinHeight = p.data("scale-min-height")
          ? p.data("scale-min-height")
          : c.scaleMinHeight),
        (c.animation = p.data("animation") ? p.data("animation") : c.animation),
        (c.easing = p.data("easing") ? p.data("easing") : c.easing),
        (c.speed = p.data("speed") ? p.data("speed") : c.speed),
        (c.carousel = p.data("carousel") ? p.data("carousel") : c.carousel),
        (c.carouselVisible = p.data("carousel-visible-slides")
          ? p.data("carousel-visible-slides")
          : c.carouselVisible),
        (c.showProgressBar = p.is('[data-progress-bar="false"]')
          ? !1
          : c.showProgressBar),
        (c.autoAdvance = p.is("[data-auto-advance]") ? !0 : c.autoAdvance),
        (c.interval = p.data("auto-advance-interval")
          ? p.data("auto-advance-interval")
          : c.interval),
        (c.pauseOnHover = p.is("[data-pause-on-hover=false]")
          ? !1
          : c.pauseOnHover),
        (c.navArrows = p.is("[data-nav-arrows=false]") ? !1 : c.navArrows),
        (c.navPagination = p.is("[data-nav-pagination=false]")
          ? !1
          : c.navPagination),
        (c.navShowOnHover = p.is("[data-nav-show-on-hover=false]")
          ? !1
          : c.navShowOnHover),
        F.is("[data-nav-dark]") &&
          (p.addClass("tms-nav-dark"),
          p.is("[data-featured-slider]") && a("header").addClass("nav-dark")),
        c.fullscreen &&
          (p.css({ top: 0, left: 0 }).addClass("tms-fullscreen"),
          (c.carouselVisible = 1),
          (c.fsUseHeightOf =
            c.fsUseHeightOf || p.data("fs-use-height")
              ? c.fsUseHeightOf && !p.data("fs-use-height")
                ? c.fsUseHeightOf
                : p.data("fs-use-height")
              : ""),
          (c.fsUseHeightOf = c.fsUseHeightOf
            ? "parent" === c.fsUseHeightOf
              ? p.parent()
              : p.closest("." + c.fsUseHeightOf)
            : "")),
        (c.parallax = p.is("[data-parallax]") ? !0 : c.parallax),
        (c.parallaxSpeed = p.data("parallax-speed")
          ? p.data("parallax-speed")
          : c.parallaxSpeed),
        (c.parallaxScaleOut = p.is("[data-parallax-scale-out]")
          ? !0
          : c.parallaxScaleOut),
        (c.parallaxFadeOut = p.is("[data-parallax-fade-out]")
          ? !0
          : c.parallaxFadeOut),
        c.captionScaling || p.addClass("tms-caption-no-scaling"),
        !c.carousel && c.carouselVisible && (c.carouselVisible = 1),
        c.carouselVisible > 1 && (c.animation = "slide"),
        c.carousel && p.addClass("tms-carousel"),
        c.carouselScaleHeight && p.addClass("tms-scalable-height"),
        E && ((c.autoPlay = !1), (c.useVideoAPI = !1)),
        c.navShowOnHover && p.addClass("show-on-hover"),
        c.navArrows && S.children().length > 1)
      ) {
        var z = a('<a href="#" />')
          .attr("id", "tms-prev")
          .addClass("tms-arrow-nav");
        // TODO: slideShow buttons
        // .appendTo(p),
        C = a('<a href="#" />')
          .attr("id", "tms-next")
          .addClass("tms-arrow-nav");
        ...
        z.each(function () {
          a(this).on("click", function (a) {
            a.preventDefault(),
              c.autoAdvance && p.data("loaded") && b.resetSlideshow(),
              b.prevSlide();
          });
        }),
          C.each(function () {
          ...
          c.lazyLoad && p.find(".tms-arrow-nav").css({ display: "block" });
      }
      if (c.navPagination && S.children().length > 1) {
        for (
          var H = a("<div>").addClass("tms-pagination").appendTo(p), k = 1;
          k < S.children().length + 1;
          k++
        )
          p.find(H).append(
        ...
        var P = p.find(
          "bullets" === c.paginationType ? ".tms-bullet-nav" : ".tms-thumb-nav"
        );
        P.each(function () {
            ...
            return (
              ...
              a(this).hasClass("active")
                ...
                : (c.autoAdvance && p.data("loaded") && b.resetSlideshow(),
                  ...
                  parseFloat(H.find(".active").data("index"))
                    ? b.slideTo(a(this).data("index"), "next")
                    : b.slideTo(a(this).data("index"), "prev"),
                  !1)
            );
          });
        }),
          H.find(".tms-bullet-nav:first-child").addClass("active"),
          c.lazyLoad && H.css({ display: "block" });
      }
              ...
              V[37] && V[39]
                ...
                : (V[37]
                    ? (c.autoAdvance && p.data("loaded") && b.resetSlideshow(),
                      c.lazyLoad
                        ? b.prevSlide()
                        : p.data("loaded") && b.prevSlide())
                    : V[39] &&
                      (c.autoAdvance && p.data("loaded") && b.resetSlideshow(),
                      c.lazyLoad
                        ? b.nextSlide()
                        : p.data("loaded") && b.nextSlide()),
                  i)
            );
          })
          .on("keyup", function (a) {
      ...
      p.swipeIt({
        ...
        a(t).on("resize", function () {
          p.data("first-load") &&
            ...
            (x = c.fulscreen
              ? a(t).height()
              : parseFloat(
                  p.data("height") ? p.data("height") : p.css("height")
                )),
            p.data("refW", y).data("refH", x).data("carousel-height", x));
          var e = p.find("li.active, li.target");
          c.carousel && c.carouselVisible > 1
        ...
        p.parent().hasClass("tm-slider-parallax-container") && c.parallax
          ? (a(t).on("scroll", function () {
              d(p, c);
            }),
            l(p, c))
          : !p.parent().hasClass("tm-slider-parallax-container") &&
            c.parallax &&
            console.log(
      ...
      (b.initSlideshow = function () {
        return I || S.children().length < 2
          ? !1
          : ((c.autoAdvance = !0),
            !E &&
              c.pauseOnHover &&
              (S.on("mouseleave ", b.resumeSlideshow),
              S.on("mouseenter ", b.pauseSlideshow)),
            c.showProgressBar &&
              (R = a("<div>").addClass("tms-progress-bar").appendTo(p)),
            b.startSlideshow(),
            N(c.interval),
            (B = new Date().getTime()),
            (U = c.interval),
            c.onSlideshowStart && c.onSlideshowStart(),
            i);
      }),
          ...
          (a = a ? L : c.interval),
            (I = setInterval(function () {
              a !== c.interval &&
                ...
                b.startSlideshow()),
                (B = new Date().getTime()),
                i !== R && R.css({ transition: "none", width: "0px" }),
                N(c.interval),
                b.nextSlide();
            }, a));
        }),
        (b.pauseSlideshow = function () {
          return W || !I
            ...
            : (clearInterval(I),
              ...
              (L = 50 > U - (D - B) ? 50 : U - (D - B)),
              (U = 0 === U ? c.interval : L),
              i !== R && R.stop().css({ width: R.width() + "px" }),
              (W = !0),
              c.onSlideshowPause && c.onSlideshowPause(),
              i);
        }),
        ...
        (b.endSlideshow = function () {
          return I
            ? (clearInterval(I),
              ...
              !E &&
                c.pauseOnHover &&
                (S.off("mouseleave ", b.resumeSlideshow),
                S.off("mouseenter ", b.pauseSlideshow)),
              i !== R && R.remove(),
              c.onSlideshowEnd && c.onSlideshowEnd(),
              i)
            : !1;
        });
      var N = function (a) {
      ...
      (b.nextSlide = function () {
        ...
        if (
          ((e = a.inArray(t, T) + 1 === 0 ? 1 : a.inArray(t, T) + 1),
          c.carousel && c.carouselVisible > 1)
        ) {
          var i = v(p, c);
          1 !== i &&
            (e = e === S.children().length - (i - 2) ? 1 : a.inArray(t, T) + 1);
        }
        this.slideTo(e, "next");
      }),
        ...
        (b.slideTo = function (e, t) {
          if (
            (p.data("first-load", !1),
            t || (F = p.find("li.active")),
            p.data("transitioning") || e === a.inArray(F.attr("id"), T) + 1)
          )
            return !1;
          f(p, e);
          var i = p.width(),
          ...
          n.addClass("target").css({ zIndex: 2, opacity: 0 === s ? 0 : 1 }),
            F.css({ zIndex: 1 }),
            p.removeClass("tms-nav-dark"),
            a("header").removeClass("nav-dark"),
            n.is("[data-nav-dark]") &&
              (p.addClass("tms-nav-dark"),
              p.is("[data-featured-slider]") &&
          ...
          A
            ? c.carousel
              ...
              : (n.css({
                ...
                clearTimeout(q),
                (q = setTimeout(function () {
                  u(F, 1, -s * t, 0, 0, 0, 0, 0, 1, c.speed, 0, M[c.easing], c),
                    u(n, 1, 0, 0, 0, 0, 0, 0, 1, c.speed, 0, M[c.easing], c);
                }, 50)))
            : c.carousel
            ? (p.data("transitioning", !0),
              S.animate(
                { opacity: 1, left: -(s / r) * t + "px" },
                c.speed,
                c.easingFallback,
                function () {
                  h(p, c);
            ...
            : (p.data("transitioning", !0),
              n
                .css({ left: i * t + "px", visibility: "visible" })
                .animate(
                  { opacity: 1, left: "0px" },
                  c.speed,
                  c.easingFallback,
              ...
              F.animate({ left: -i * t + "px" }, c.speed, c.easingFallback));
        }),
        n(p, c, b);
    },
    d = function (e, i) {
    ...
    u = function (e, t, i, s, n, r, o, d, l, c, u, p, f) {
      ...
      (e.hasClass("active") ||
        ...
        (v.data("transitioning", !0), f.onSlideBefore && f.onSlideBefore());
      var m = {};
      (m.transform =
        "translate3d(" +
        i +
        ...
        l +
        ")"),
        (m.transitionProperty = V + ", opacity"),
        (m.transitionDuration = c + "ms"),
        (m.transitionDelay = u + "ms"),
        (m.transitionTimingFunction = p),
        (m.visibility = "visible"),
        (m.opacity = t),
        e.css(m).on(I, function (e) {
          e.stopPropagation(),
            a(this).off(I),
            (a(this).hasClass("target") || a(this).hasClass("tms-slides")) &&
              h(v, f),
    ...
    h = function (a, e) {
      ...
      return (
        ...
        s.removeClass("target").addClass("active"),
        (t = s),
        y(t, "play", e),
        e.carouselVisible > 1 ? !1 : (p(t, e), i)
      );
    },
    p = function (e, t) {
      e.find(".tms-caption")
    ...
    m = function (e, t) {
      ...
      n
        ...
        2 === c && o > n.children().length - 2
          ? ((i = n.children().length - 1), (s = !0))
          : 3 === c && o > n.children().length - 3
          ? ((i = n.children().length - 2), (s = !0))
          : o > n.children().length - c
          ? ((i = n.children().length - c + 1), (s = !0))
          : ((i = o), (s = !1)),
        d
          .children()
          .hide()
          .slice(0, n.children().length - c + 1)
          .show(),
        s &&
        ...
        A
          ...
          : n.css({ width: u * l + "px", left: -(u * i) + "px" });
    },
    g = function (e, i) {
      var s = e.closest(".tm-slider-container, .featured-media"),
        ...
        c = s.data("external-padding")
          ? parseFloat(s.data("external-padding"))
          : i.externalPadding,
      ...
      if (
        ...
        i.carousel
          ...
          : (s.css({
              width: Math.round(u) + "px",
              height:
                h > i.scaleMinHeight || "auto" === i.scaleMinHeight
                  ? Math.round(h) + "px"
                  : i.scaleMinHeight + "px",
            }),
            ...
            (h =
              h > i.scaleMinHeight || "auto" === i.scaleMinHeight
                ...
                : i.scaleMinHeight),
            s.data("newSH", h)),
        !s.data("setup") || (i.carousel && i.carouselVisible > 1))
      )
        return !1;
      var g = e.is("[data-image]") ? "image" : "video",
        w = e.is("[data-video-bkg]") ? !0 : !1,
        y = e.is("[data-video-ratio]")
      ...
      e
        ...
        .each(function () {
              ...
              : "video" === g &&
                ...
                w
                  ...
                  : ((t =
                    ...
                    (s = t / y))),
            (n = t / s),
            ("image" === g && i.fullscreen) || m || ("video" === g && w))
          ) {
          ...
          } else "video" === g && a(this).css({ width: Math.floor(t) + "px", height: Math.floor(s) + "px", top: Math.floor((h - s) / 2) + "px", left: Math.floor((u - t) / 2) + "px" });
        }),
        b(e, i);
    },
    b = function (e, t) {
                ...
                e.css(
                  e.find("img").length || e.find("iframe, video").length
                    ...
                    : {
                        ...
                        borderTopWidth:
                          n * (b / o) > b ? b : Math.ceil(n * (b / o)) + "px",
                        borderRightWidth:
                          n * (w / o) > w ? w : Math.ceil(n * (w / o)) + "px",
                        borderBottomWidth:
                          n * (y / o) > y ? y : Math.ceil(n * (y / o)) + "px",
                        borderLeftWidth:
                          n * (x / o) > x ? x : Math.ceil(n * (x / o)) + "px",
                        whiteSpace: "nowrap",
                      }
                ),
                e.css({
                  top:
                    "top" === s
                      ...
                      : "bottom" === s
                      ? r - e.outerHeight() - C
                      : (r - e.outerHeight()) / 2 + C + "px",
                  left:
                    "left" === i
                      ? 0 + z
                      : "right" === i
                      ? n - e.outerWidth() - z
                      : (n - e.outerWidth()) / 2 + z + "px",
                });
            }
          }),
          i);
    ...
    y = function (e, t, s) {
      ...
      try {
        if (e.find("iframe").length) {
          ...
          var r = a(n).attr("src");
          i !== r && r.indexOf("vimeo") > -1
            ? ((n = $f(a(n)[0])),
              n.api("play" === t && s.autoPlay ? "play" : "pause"))
            : i !== r &&
              r.indexOf("youtu") > -1 &&
              ((n = n.replace("#", "")),
              "play" === t && s.autoPlay ? x[n].playVideo() : x[n].stopVideo());
        } else
          e.find("video").length &&
            ((n = "#" + e.find("video").attr("id")),
            "play" === t && s.autoPlay ? a(n)[0].play() : a(n)[0].pause());
      } catch (o) {}
    },
    x = {},
    S = !1,
    ...
    T = function (s, n) {
      ...
      if (
        ...
        f && n.autoPlay && (p.load(), (p.autoplay = !0)),
          s.parent().is("[data-video-bkg]") && (p.muted = n.muteBkgVideo),
          n.replayOnEnd && (p.loop = !0);
      }
    },
    O = (function () {
      var a = {};
  ...
  var z,
    C = e.body || e.documentElement,
    H = C.style,
    A =
      H.transition !== i ||
      H.WebkitTransition !== i ||
      H.MozTransition !== i ||
      H.MsTransition !== i ||
      H.OTransition !== i,
    k = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
  for (var P in k)
    H[k[P]] !== i && (z = "-" + k[P].replace("Transform", "").toLowerCase());
  var V = z + "-transform",
    I =
      "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
    M = {
...
!(function (t, i, e, a) {
  ...
  var n = function (i, a) {
      ...
      c.on("click", function (i) {
        ...
        (d.nextContent = function () {
          ...
          (r = t.inArray(r, a) + 1 === 0 ? a[0] : r),
            e.removeClass("tml-active"),
        ...
        (d.prevContent = function () {
          ...
          var e = t(".tml-active"),
            a = o(e),
            r = a[t.inArray(e.attr("id"), a) - 1];
          (r = t.inArray(r, a) + 1 === 0 ? a[a.length - 1] : r),
            e.removeClass("tml-active"),
            (r = t("#" + r).addClass("tml-active")),
            s(r, "prev", n),
            (a.length = 0);
        ...
        (d.destroyLightbox = function () {
          ...
          if (b) {
            ...
            i.children().css({ transition: "none" }),
            ...
            e.remove(),
              i.animate(
                { opacity: 0, left: o.x + "px", top: o.y + "px" },
                n.speed,
                n.easing,
                function () {
                  i.find("iframe").attr("src", ""), i.remove(), (i = null);
    ...
    o = function (i) {
      if (t(i).is("[data-group]")) {
        var e = t(i).data("group"),
          a = [];
        return (
          t('[data-group="' + e + '"]').each(function (i) {
            i++,
              t(this).attr("id")
                ? a.push(t(this).attr("id"))
                : (t(this).attr("id", e + "-tml-thumb-" + i),
                  a.push(t(this).attr("id")));
          }),
          a
        );
    ...
    l = function (a, n, o, l) {
      ...
      o.is("[data-modal-mode]") &&
        (s.addClass("tml-modal-mode"),
        h.addClass("modal-dialog"),
        t("body").addClass("modal-open"),
        o.data("modal-width") && s.data("modal-width", o.data("modal-width")),
        o.data("modal-height") &&
          s.data("modal-height", o.data("modal-height"))),
        s.data("initLoad", !0);
      ...
      if (
        ...
        n.overlay || s.css({ background: "none" }),
      ...
      n.navKeyboard &&
        t(i).on("keyup", function (t) {
          37 != t.keyCode || a.length < 2
            ? 39 != t.keyCode || a.length < 2
              ? 27 == t.keyCode && l.destroyLightbox()
              : l.nextContent()
            : l.prevContent();
        }),
        n.overlayClickClose &&
    ...
    s = function (i, e, a) {
      ...
      if (((e = "next" === e ? 1 : -1), b))
        n.one(w, function () {
          t(this).css({ visibility: "hidden" }), c(i, e, a);
        }),
          u(n, 0, -o * e, 0, a);
      else {
        var r = n.position().left;
        n.animate(
          { opacity: 0, left: r - o * e + "px" },
          a.speed,
          a.easing,
          function () {
            t(this).css({ visibility: "hidden" }), c(i, e, a);
    ...
    c = function (i, a, n) {
      ...
      if (
        ...
        ((e.isRetinaDevice() && n.retinaSupport) ||
          (e.isRetinaDevice() && i.is("[data-retina]"))) &&
          ((!z && !n.retinaSupportMobile) || (z && n.retinaSupportMobile)) &&
          (c = c.replace(v, n.retinaSuffix + v)),
          r.data("type", "img"),
          t("<img />")
            .addClass("tml-image")
            .attr("src", c)
      ...
      if (h)
        if (
          (r.addClass("scrollable-content").data("type", "inline"), t(c).length)
        ) {
          var g = t(c)
            .clone(!0)
            .addClass("show")
      ...
      if (p) {
        ...
        var x = t(
          '<iframe src="' + c + '" frameborder="0" scrolling="auto" />'
        );
        r.html(x),
          x.one("load", function () {
            d(!0, a, n);
    ...
    d = function (i, e, a) {
      ...
      if ((m(a), n.find("#tml-loader").remove(), i)) {
        ...
        if (b)
          ...
          o.css({ visibility: "visible", left: c + "px" }).animate(
            { opacity: 1, left: s + "px" },
            a.speed,
            a.easing,
            function () {
        ...
        var d = "";
        a.showErrorSrc && (d = ": " + t(".tml-active").attr("href")),
          o
            .css({
              width: "100%",
              height: "auto",
    ...
    m = function (i) {
      ...
      if (
        (s
          .not(".tml-error")
          .css({ height: "auto", width: "auto", top: "", left: "" }),
        "img" === c)
      )
        (m = s.find("img").width()), (u = s.find("img").height());
    ...
    u = function (i, e, a, n, o) {
      ...
      var l = {};
      (l.transform = "translate3d(" + a + "px, " + n + "px, 0px)"),
        (l.transitionProperty = y + ", opacity"),
        (l.transitionDuration = o.speed + "ms"),
        (l.transitionTimingFunction = C[o.easing]),
        (l.visibility = "visible"),
        (l.opacity = e),
        i.css(l).one(w, function (e) {
          e.stopPropagation(),
            t(this).off(w),
            "tm-lightbox" === i.attr("id") && r.data("transitioning", !1);
        });
    },
    h = function (i, e) {
      var a = t("#tml-caption"),
      ...
      n
        ? (a.html(t("<span />").text(n)),
          b
            ? u(t("#tml-caption"), i, 0, 0, e)
            : t("#tml-caption").animate({ opacity: i }))
        : a.html("");
    };
  ...
  var p,
    f = i.body || i.documentElement,
    v = f.style,
    b =
      v.transition !== a ||
      v.WebkitTransition !== a ||
      v.MozTransition !== a ||
      v.MsTransition !== a ||
      v.OTransition !== a,
    g = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
  for (var x in g)
    v[g[x]] !== a && (p = "-" + g[x].replace("Transform", "").toLowerCase());
  var y = p + "-transform",
    w =
      "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
    C = {
  ...
  (navigator.userAgent.match(/Android/i) ||
    ...
    navigator.userAgent.match(/Windows Phone/i)) &&
    (z = !0),
    (t.fn.summitLightbox = function (i) {
      return this.each(function () {
        var e = t(this);
...
!(function (t, a, i, e) {
  ...
  function n(a, e) {
    ...
    g && n.css({ height: "" }).addClass("tmp-mobile");
    var o = t('<div class="tm-loader"><div id="circle" /></div>');
    o.appendTo(n);
    var s = a.data("src"),
      c = s.substr(s.lastIndexOf("."));
    ((i.isRetinaDevice() && e.retinaSupport) ||
      (i.isRetinaDevice() && a.is("[data-retina]"))) &&
      ((!g && !e.retinaSupportMobile) || (g && e.retinaSupportMobile)) &&
      (s = a.data("src").replace(c, e.retinaSuffix + c)),
      t('<img class="tmp-media"/>')
        .attr("src", s)
        .one("load", function () {
          t(this).attr("src", s).appendTo(n),
  ...
  function r(a, e) {
    ...
    n.data("refW", n.width()).data("refH", n.height()),
      ...
      m && d(a)
        ...
        : n.css({ visibility: "visible" }).animate({ opacity: 1 }),
  ...
  var o = function (a, i) {
      ...
      r
        ...
        .data("refH", r.height()),
        c(r, e),
        e.fullscreen && (e.scaleContainer = !0),
        e.parallaxFactor > 1 && (e.parallaxFactor = 1),
        r.data("setup", !0),
        n(r, e);
    },
    s = function (t, a) {
    ...
    c = function (a, e) {
      ...
      if (
        ((e.fullscreen || e.scaleContainer) &&
          ...
          (l = Math.round(l) > e.scaleMinHeight ? l : e.scaleMinHeight)),
        !a.data("setup"))
      )
        return !1;
      var d = a.find(".tmp-media"),
        ...
        u = h / p,
        m = e.fullscreen
          ? r + r * e.parallaxFactor
          : e.scaleContainer
          ? l + l * e.parallaxFactor
        ...
        if (
          ...
          var l,
            ...
            p =
              e.fadeThreshold > 1
                ? 0.5 * a.height()
                : a.height() * e.fadeThreshold;
          o > p || (l = Math.abs(r / p) > 1 ? 1 : Math.abs(r / p)),
            o > h || h - p > o || (l = (h - o) / p > 1 ? 1 : (h - o) / p),
            n.parent().css({ opacity: (Math.ceil(100 * l) / 100).toFixed(2) });
        }
      } else g || n.css({ visibility: "hidden" });
      a.data("animating", !1);
    },
    d = function (a) {
      var e = t(i).scrollTop(),
  ...
  var h,
    p = a.body || a.documentElement,
    u = p.style,
    m =
      u.transition !== e ||
      u.WebkitTransition !== e ||
      u.MozTransition !== e ||
      u.MsTransition !== e ||
      u.OTransition !== e,
    f = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
  for (var v in f)
    u[f[v]] !== e && (h = "-" + f[v].replace("Transform", "").toLowerCase());
  var g = !1;
  (navigator.userAgent.match(/Android/i) ||
    navigator.userAgent.match(/webOS/i) ||
    navigator.userAgent.match(/iPhone/i) ||
    ...
    (function () {
      for (
        var t = 0, a = ["ms", "moz", "webkit", "o"], e = 0;
        e < a.length && !i.requestAnimationFrame;
        ++e
      )
        (i.requestAnimationFrame = i[a[e] + "RequestAnimationFrame"]),
          (i.cancelAnimationFrame =
            i[a[e] + "CancelAnimationFrame"] ||
            i[a[e] + "CancelRequestAnimationFrame"]);
      i.requestAnimationFrame ||
        (i.requestAnimationFrame = function (a) {
...
!(function (a, e, t, i) {
  ...
  var n,
    r = function (e, i) {
      ...
      (e = a(e)),
        F && e.css({ opacity: 1, visibility: "visible" }),
      ...
      a.each(r, function (a, t) {
        ...
        "opacity" === i && e.data("o", n),
          "scale" === i && e.data("s", n),
          "easing" === i && e.data("e", n),
          "transX" === i && e.data("tx", parseFloat(n)),
          "transY" === i && e.data("ty", parseFloat(n)),
          "transZ" === i && e.data("tz", parseFloat(n)),
          "rotateX" === i && e.data("rx", parseFloat(n)),
          "rotateY" === i && e.data("ry", parseFloat(n)),
          "rotateZ" === i && e.data("rz", parseFloat(n)),
          "duration" === i && e.data("du", parseFloat(n)),
          "delay" === i && e.data("de", parseFloat(n));
      }),
        a(t).on("scroll", function () {
          o(e, n);
        }),
    ...
    s = function (a, e) {
      if (c(a, e)) {
        ...
        m
          ? d(a, 1, 0, 0, 0, 0, 0, 0, 1, t, i, n, e)
          : a
              .css({ visibility: "visible" })
              .stop()
              .animate({ opacity: 1 }, e.speed, e.easingFallback, function () {
                e.inView && e.inView();
              });
      }
      a.data("scrolling", !1);
    ...
    c = function (e, i) {
      ...
      return (
        (c - n > a(t).height() || c - n < -e.outerHeight()) &&
          (i.recurring && u(e, i), i.outOfView && i.outOfView()),
        r >= l && b >= n
      );
    },
    u = function (a) {
    ...
    d = function (e, t, i, n, r, o, s, c, u, d, b, l, m) {
      ...
      (p.transform =
        ...
        u +
        ")"),
        (p.transitionProperty = g + ", opacity"),
        (p.transitionDuration = d + "ms"),
        (p.transitionDelay = b + "ms"),
        (p.transitionTimingFunction = l),
        (p.visibility = "visible"),
        (p.opacity = t),
        e.css(p).on(z, function (e) {
    ...
    m =
      l.transition !== i ||
      l.WebkitTransition !== i ||
      l.MozTransition !== i ||
      l.MsTransition !== i ||
      l.OTransition !== i,
    p = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
  for (var f in p)
    l[p[f]] !== i && (n = "-" + p[f].replace("Transform", "").toLowerCase());
  var g = n + "-transform",
    z =
      "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
    h = {
  ...
  determinePlayback: function (a, b, c, d, e) {
    ...
    if (typeof b.type != "undefined" && b.type !== "")
      if (typeof b.type == "string") g.push({ type: b.type, url: e });
        ...
        for (f = 0; f < b.type.length; f++) g.push({ type: b.type[f], url: e });
    else if (e !== null) {
...
$(document).ready(function () {
  ...
  var e = ".header",
    ...
    ui = [
      "Downtown New York Office<br>44 St. West 32",
      "The Brooklyn Office<br>East Village 55th St.",
    ],
    fi = 45,
    pi = 53,
    gi = 12,
    ...
    Si = "body",
    Ti =
      ".fade-location, .logo a, .footer-logo a, .navigation a, .side-navigation a, .overlay-navigation a, .grid .overlay-link, .post-media .overlay-link, .post-title a, .post-read-more a, .pagination-previous, .pagination-next",
    zi =
    ...
    Pi = {
      init: function () {
        Pi.siteHeader(),
          Pi.retinize(),
          Pi.equalize(768),
          Pi.parallax(".parallax.fixed-height", !0, !1, !0),
          Pi.parallax(".parallax.fullscreen", !0, !0, !0),
          Pi.fullScreenSection(),
          Pi.masonry(),
          Pi.logoSlider(),
          Pi.heroSlider(),
          Pi.testimonialSlider(),
          Pi.teamSlider(),
          Pi.portfolioSlider(),
          Pi.carouselSlider(),
          Pi.contentSlider(),
          ...
          Pi.fullWidthSlider(),
          Pi.lightbox(),
          Pi.counter(".stat", ".stat-counter", !1),
          Pi.horizon(".horizon", ".parallax .horizon", "easeInOutQuint", !1, 1),
          Pi.videos(),
          Pi.mediaElement(),
          Pi.signupForm(),
          Pi.contactForm(),
          Pi.enablePlaceHolder(),
          document.getElementById("map-canvas") &&
            google.maps.event.addDomListener(window, "load", Pi.googleMap),
          Pi.pageFade(),
          Pi.scrollToSection();
      },
      retinize: function () {
      ...
      equalize: function (e) {
        imagesLoaded($(d), function () {
          $(d).equalizeHeights({ clearUnder: e });
        });
      },
      ...
      horizon: function (e, i, o, a, t) {
        $(e).not(i).horizon({ easing: o, recurring: a, threshold: t });
      },
      counter: function (e, i, o) {
        $(i).counter({ autoStart: !1 }),
          $(e).each(function () {
            var e = $(this);
            e.horizon({
              recurring: o,
              inView: function () {
                return e.find(i).data("counting")
                  ? !1
                  : void e.find(i).each(function () {
              ...
              outOfView: function () {
                return o && e.find(i).data("counting")
                  ? void e.find(i).each(function () {
      ...
      videos: function () {
        fluidvids.init({ selector: b, players: S });
      },
      ...
      siteHeader: function () {
        function l() {
          (d = $(window).width()),
            (c = $(window).height()),
            (h = Math.ceil(C.outerHeight())),
            (u =
              "window-height" === C.data("bkg-threshold")
                ? c - h
                : C.data("bkg-threshold")),
            (f =
              "window-height" === C.data("compact-threshold")
                ? c - h
                : C.data("compact-threshold")),
            (p =
              "window-height" === C.data("sticky-threshold")
                ? c - h
                : C.data("sticky-threshold")),
            (g = C.data("helper-in-threshold")),
            (m = C.data("helper-out-threshold"));
        }
        var d,
          c,
          h,
        ...
        var b = function (i) {
            if (1) return;
            let foo =
              $("body").hasClass("mobile") || y > d
                ? !1
                : ((p && $(i).scrollTop() >= p) || 0 === p
                    ? ($(e).addClass(o), g && m && $(e).addClass(r))
                    : ($(e).removeClass(o), g && m && $(e).removeClass(r)),
                  u && $(i).scrollTop() >= u
                    ? console.log(
                        "Header height:",
                        $(e),
                  ...
                  (v = $(i).scrollTop()),
                  v > w
                    ? (g && $(i).scrollTop() >= g && $(e).addClass(n),
                      $(e).removeClass(s))
                    : w > v &&
                      (g &&
                        $(i).scrollTop() <= g &&
                        ($(e).removeClass(n), $(e).removeClass(s)),
                      !g ||
                        $(i).scrollTop() < g ||
                        $(i).scrollTop() > m ||
                        ($(e).addClass(s),
                        $(s).on(ki, function (o) {
                          return (
                            o.stopPropagation(),
                            o.target !== $(i)[0] ? !1 : void $(e).removeClass(s)
                          );
                        }))),
                  void (w = v));
            return foo;
          ...
          S = function () {
            // TODO
            // Adds header-backgound if window is resized.
            return (
              l(),
              $("body").hasClass("mobile")
                ? !1
                : (d > y && x, //&& C.css({ height: C.outerHeight() + "px" })
                  d > y && $(window).scrollTop() >= p
                    ? ($(e).addClass(o), g && m && $(e).addClass(r))
                    : ($(e).removeClass(o), g && m && $(e).removeClass(r)),
                  d > y && $(window).scrollTop() < u
                    ? $(e).removeClass(a)
                    : d > y && $(window).scrollTop() > u && $(e).addClass(a),
                  d > y && $(window).scrollTop() < f
                    ? $(e).removeClass(t)
                    : d > y && $(window).scrollTop() > f && $(e).addClass(t),
                  void (y > d && $(e).removeClass(t)))
            );
          };
        $(window).on("scroll", function () {
          // debugger;
          ...
          $("body").hasClass("mobile") ||
            $(window).one("load", function () {
              l(),
                b($(this)),
                // TODO: this sets header height
                // d > y && x && C.css({ height: h + "px" }),
                $(e).addClass(i);
            });
      },
      fullScreenSection: function () {
        var e = function () {
            ...
            if ($(c).find(h).length > 1) {
              ...
              var i,
                o = $(c).hasClass("no-navigation") ? !1 : !0;
              if (o) {
                i = $("<div>").addClass("fs-pagination").appendTo($(c));
                for (var a = 1; a < $(c).children().length; a++)
                  (e = $(c)
                    .children()
                    .eq(a - 1)
                    .attr("id")),
                ...
                n.each(function () {
                  $(this).on("click", function (i) {
                    if ((i.preventDefault(), $(this).hasClass("active")))
                      return !1;
                ...
                r = function (e) {
                  if (Pi.isElementVisible(e, g) && o) {
                    ...
                    i.find(".active").removeClass("active"),
                      i.find("#fs-pagination-" + a).addClass("active"),
                      e.hasClass("nav-dark")
                        ? i.addClass("nav-dark")
                        : i.removeClass("nav-dark");
                  }
                  $(i).css(
                    o && Pi.isElementVisible($(c), g)
            ...
            $(h).each(function () {
              ...
              if ($(this).is("[data-width],[data-height]"))
                if ($("body").hasClass("mobile") || 768 >= o) {
                  ...
                  (d = s && s >= d ? s : d),
                    e.css({ height: "auto" }),
                    i.css({ height: d + "px", minHeight: d + "px" });
                } else
                  e.removeClass("fs-image-scale"),
                    e.css({ height: "" }),
                    i.css({ height: "", minHeight: "" });
              else
                $("body").hasClass("mobile") || 768 >= o
                  ? i.css({ height: a + "px" })
                  : (e.removeClass("fs-image-scale"),
                    e.css({ height: "" }),
                    i.css({ height: "", minHeight: "" }));
      ...
      isElementVisible: function (e, i) {
        if (
          ((i = e.is("[data-visible-threshold]")
            ? e.data("visible-threshold")
            : g),
          void 0 === e.offset())
        )
          return (
        ...
        return (
          e.is($(c)) ||
            (r > t || a > s ? e.removeClass("in-view") : e.addClass("in-view")),
          t >= r && s >= a
        );
      },
      scrollPage: function (e, i) {
        $("html, body").animate({ scrollTop: $(e).offset().top + i }, f, p);
      },
      masonry: function () {
        $(m).each(function () {
          var e,
          ...
          if (o.data("layout-mode")) {
            (e = o.data("layout-mode") ? o.data("layout-mode") : "masonry"),
              o.is("[data-layout-mode]") && o.addClass("masonry"),
              o.is("[data-set-dimensions]") &&
                o.addClass("masonry-set-dimensions"),
              (x = o.is("[data-animate-resize]") ? !0 : !1),
              (C = o.is("[data-animate-resize-duration]")
                ? o.data("animate-resize-duration") + "s"
                : C),
              o.is(".masonry-set-dimensions, .masonry-set-dimensions-2")
                ? (o.is(".full-width.no-margins") &&
                    Pi.masonryWrapperWidth(o, a),
                  (i = Pi.masonryColWidth(o, a)),
                  Pi.masonryThumbSizes(o, a, Pi.masonryColWidth(o, a)))
                : (i = ".grid-sizer");
            ...
            t.appendTo(o),
              imagesLoaded(a, function () {
                a.isotope({
                  ...
                  o.find(t).remove(),
                  a.css({ visibility: "visible", minHeight: "initial" });
                var n = a.children().length - 1;
                $("body").hasClass("transition-support") ||
                  o.removeClass("fade-in-progressively"),
                      ...
                      x
                        ? a.isotope({
                            ...
                            masonry: {
                              columnWidth:
                                ".grid-sizer" !== i
                                  ? Pi.masonryColWidth(o, a)
                                  : ".grid-sizer",
                            },
                          })
                        : (a.removeClass("filtering"),
                          a
                            .isotope({
                            ...
                            .isotope("layout")
                            .isotope({ transitionDuration: C }));
                  });
              });
          } else a.css({ visibility: "visible" });
        }),
          $(w).each(function () {
            $(this)
              .find("a")
              .on("click", function (e) {
                e.preventDefault(),
                  $(this).closest(w).find(".active").removeClass("active"),
                  $(this).addClass("active");
                var i = $(this).closest(w).data("target-grid")
                  ? $(this).closest(w).data("target-grid")
                  : m;
                (i = $(i).find(".grid")),
                  (y = i.is("[data-animate-filter-duration]")
                    ? i.data("animate-filter-duration") + "s"
                    : y),
                  i.isotope({ transitionDuration: y });
                var o = $(this).attr("data-filter");
                $(i).addClass("filtering").isotope({ filter: o });
              });
          });
      },
      masonryWrapperWidth: function (e, i) {
        var o = Math.ceil(1.001 * e.width());
        i.css({ maxWidth: o + "px", width: o + "px" });
      },
      masonryColWidth: function (e, i) {
        ...
        return (
          e.is(".full-width.small-margins, .full-width.no-margins")
            ? (i.hasClass("content-grid-2") && (o = 480 > a ? n / 1 : n / 2),
              i.hasClass("content-grid-3") &&
                (o = a > 768 ? n / 3 : 768 >= a && a > 480 ? n / 2 : n / 1),
              i.hasClass("content-grid-4") &&
                (o =
                  a > 1140
                    ? n / 4
                    : 1140 >= a && a > 768
                ...
                (o =
                  a > 1300
                    ...
                    ? 768 >= a && a > 480
                      ...
                      : n / 1
                    : n / 3))
            : (i.hasClass("content-grid-2") && (o = 600 > a ? n / 1 : n / 2),
              i.hasClass("content-grid-3") &&
                (o = a > 960 ? n / 3 : 960 >= a && a > 600 ? n / 2 : n / 1),
              i.hasClass("content-grid-4") &&
                (o =
                  a > 1140
                    ? n / 4
      ...
      masonryThumbSizes: function (e, i, o) {
        var a,
          t = $(window).width(),
          n = 2,
          s = $(".masonry-set-dimensions").hasClass("no-margins")
            ? 0
            : parseFloat(i.find(".grid-item").css("padding-left")),
          r = e.is(".masonry-set-dimensions")
            ? e.is("[data-grid-ratio]")
              ? parseFloat(e.data("grid-ratio"))
              : 1.5
            : 1;
        if (
          ((a = Math.floor((o - s) / r + s)), e.is(".masonry-set-dimensions"))
        ) {
          var l = e.is(".full-width.small-margins, .full-width.no-margins")
            ? 480
            : 600;
              ...
              $(this).is(".large, .masonry-stamp.large")
                ? $(this).is(".portrait, .masonry-stamp.portrait")
                  ? {
                      ...
                      height:
                        t > l ? Math.floor(2 * a * n) + "px" : 2 * a + "px",
                    }
                  : {
                      width: t > l ? Math.floor(o * n) + "px" : o + "px",
                ...
                : $(this).is(".portrait, .masonry-stamp.portrait")
                ? { width: o + "px", height: Math.floor(a * n) + "px" }
                : { width: o + "px", height: a + "px" }
            );
          });
        }
        e.is(".masonry-set-dimensions-2") &&
          i.find(v).each(
            t > 600
              ? function () {
                  $(this).hasClass("horizontal")
                    ...
                    : $(this).css(
                        $(this).hasClass("vertical")
                          ...
                          : { width: o + "px", height: Math.floor(a) + "px" }
                      );
                }
              : function () {
                  $(this).css(
      ...
      signupForm: function () {
        $(U).submit(function (e) {
            ...
            a.each(function () {
              $(this).attr("required") &&
                ($(this).val() ||
                  ((c = !0),
                  $(this).addClass(Z),
                  o.hide().text(K).fadeIn(200)));
            }),
            c || (h = !0),
            t.val() && !Pi.isValidEmail(t.val())
              ? (o.hide().text(ei).fadeIn(200), t.addClass(Z))
              : (u = !0),
            "" !== n.val())
          )
            return !1;
          if (
            ...
            var f = $(s).val();
            $(s)
              .css({ width: $(s).outerWidth() + "px" })
              .val(G)
              .attr("disabled", !0),
              o.hide().text(Y).fadeIn(200),
              $.ajax({ url: r, type: l, data: d, dataType: "json" })
                .done(function (e) {
                  try {
                    e.response === !0
                      ? (o.text(X), o.delay(1500).fadeOut(200), a.val(""))
                      : o.hide().text(e.json.error_message).fadeIn(200);
                  } catch (i) {
                    console.log("error in parsing returned ajax data: " + i),
                      o
                        .hide()
                        .text(
                ...
                .always(function () {
                  $(s).css({ width: "" }).val(f).attr("disabled", !1);
                });
          }
        });
      },
        ...
        $(ii).submit(function (e) {
            ...
            a.each(function () {
              $(this).attr("required") &&
                ($(this).val() ||
                  ((c = !0),
                  $(this).addClass(oi),
                  o.hide().text(ri).fadeIn(200)));
            }),
            c || (h = !0),
            t.val() && !Pi.isValidEmail(t.val())
              ? (o.hide().text(li).fadeIn(200), t.addClass(oi))
              : (u = !0),
            "" !== n.val())
          )
            return !1;
          if (
            ...
            $(s)
              ...
              .val(ti)
              .attr("disabled", !0),
              o.hide().text(ai).fadeIn(200),
              $.ajax({ url: r, type: l, data: d, dataType: "json" })
                .done(function (e) {
                  try {
                    if (e.response === !0)
                      o.text(ni), o.delay(1500).fadeOut(200), a.val("");
                    else {
                      var i =
                        void 0 === e.json.error_message
                          ? "There is a possibility that your message was not sent. Please check up the server or script configuration."
                          : e.json.error_message;
                      o.hide()
                        .text(si + " " + i)
                        .fadeIn(200);
                    }
                  } catch (t) {
                    console.log("error in parsing returned ajax data: " + t),
                      console.log(e),
                      o
                        .hide()
                        .text(
                ...
                .fail(function (e, i, a) {
                  console.log("Error occured in processing your request:"),
                    ...
                    o
                      .hide()
                      .text(si + " (Please see the console for error details.)")
                      .fadeIn(200);
                })
                .always(function () {
                  $(s).css({ width: "" }).val(f).attr("disabled", !1);
      ...
      googleMap: function () {
        (ci = $(di).data("icon")
          ? JSON.parse("[" + $(di).data("icon") + "]")
          : ci),
          (hi = $(di).data("coordinates") ? $(di).data("coordinates") : hi),
          (ui = $(di).data("info")
            ? JSON.parse("[" + $(di).data("info") + "]")
            : ui),
          (gi = $(di).data("zoom-level")
            ? parseFloat($(di).data("zoom-level"))
            : gi),
          (xi =
            $(di).data("style") && "greyscale" === $(di).data("style")
              ? !0
              : !1);
        for (
          var e,
            ...
            t = {
              ...
              styles: [{ stylers: [{ saturation: o }] }],
            },
            n = new google.maps.Map(document.getElementById("map-canvas"), t),
            s = 0,
            r = 0;
          r < hi.length;
          r++
          ...
          (e = new google.maps.Marker({
            ...
            icon: new google.maps.MarkerImage(
              ...
              null,
              null,
              new google.maps.Size(fi, pi)
            ),
          })),
            (i = new google.maps.InfoWindow({ content: ui[r] })),
                ...
                $("body").hasClass("transition-support")
                  ? $(Si)
                      ...
                      .on(ki, function (e) {
                        return (
                          e.stopPropagation(),
                          e.target !== $(this)[0] ? !1 : void Pi.goToNewPage(i)
                        );
                      })
                  : Pi.goToNewPage(i);
              })
